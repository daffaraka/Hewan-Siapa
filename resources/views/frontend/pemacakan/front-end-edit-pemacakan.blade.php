...
<form action="{{route('hewan-siapa.updatePemacakan',$edit->id)}}" method="POST" enctype="multipart/form-data" class="col-md-12" >
    @csrf
    <div class="container" style="padding: 10px">
        ...
        <div class="row" style="padding: 20px;box-shadow: grey 0 0 3px; border-radius:5px;">
            ...
            <div class="col-md-5" style="margin-top:30px;">
                <img id="preview-image-before-upload" src="{{asset('storage/post/pemacakan/'.$edit->nama_post_pemacakan.'-'.$edit->image_post_pm)}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="nama_post_pm"> Judul Postingan Pemacakan</label>
                    <input type="text" name="nama_post_pemacakan" id="nama_post_pemacakan" class="form-control @error('nama_post_pemacakan') is-invalid @enderror" value="{{$edit->nama_post_pemacakan}}"> 
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="deskripsi_post_pm" id="deskripsi_post_pm" cols="30" rows="3" class="form-control @error('deskripsi_post_pm') is-invalid @enderror"> {{$edit->deskripsi_post_pm}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi_post_pm" id="lokasi_post_pm" class="form-control @error('lokasi_post_pm') is-invalid @enderror" placeholder="" value=" {{$edit->lokasi_post_pm}}">
                ...
                <div class="form-group">
                    <label for="lokasi_post_pm"> Kontak Anda pada kiriman </label>
                    <input type="text" name="kontak_pemacakan" id="kontak_pemacakan" class="form-control @error('kontak_pemacakan') is-invalid @enderror" placeholder="" value="{{$edit->kontak_pemacakan}}">
                    <small class="form-text"><label class="badge badge-dark m-0"> *Masukkan kontak anda</label> </small>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="syarat_pemacakan" id="syarat_pemacakan" cols="30" rows="3" class="form-control @error('syarat_pemacakan') is-invalid @enderror" placeholder="" > {{$edit->syarat_pemacakan}}</textarea>
